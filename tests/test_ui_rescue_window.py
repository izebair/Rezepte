...
def test_export_context_card_shows_generated_files_and_import_summary():
    ...
    try:
        ...
        assert "taxonomy_reference.md" in window.export_files_var.get()
        assert "quality_reference.md" in window.export_files_var.get()
        assert "health_reference.md" in window.export_files_var.get()
        assert "response_schema.json" in window.export_files_var.get()
        assert "response_example.json" in window.export_files_var.get()
